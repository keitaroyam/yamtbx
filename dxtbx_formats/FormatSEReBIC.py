...
#
# This code was copied from https://github.com/cctbx/dxtbx/blob/master/format/FormatSEReBIC.py and modified.
...
class FormatSEReBIC(FormatSER):
  ...
  def get_raw_data(self, index):
    ...
    if "DXTBX_SEREBIC_TRUNCATE_NEGATIVE" in os.environ:
        print("DEBUG:: truncating negative pixels")
        raw_data.set_selected(raw_data<0, 0)
    if os.environ.get("DXTBX_SEREBIC_OFFSET"):
        print("DEBUG:: adding %s"%os.environ["DXTBX_TIFFEBIC_OFFSET"])
        raw_data += int(os.environ["DXTBX_TIFFEBIC_OFFSET"])
