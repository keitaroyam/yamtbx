...
def run(cif_file, prefix=None):
    ...
    print "build=", reader.build_miller_arrays()
    print "arrays=", reader.as_miller_arrays()
        ...
        if "_shelx_hkl_file" in model[k]:
            ...
            if hklf:
                ...
                if hklf == 4:
                    ...
                    #print "N=",arrays[0].n_bijvoet_pairs()
                    #arrays[0] = arrays[0].customized_copy(miller_set=arrays[0].auto_anomalous())
                    print arrays[0].anomalous_flag()
